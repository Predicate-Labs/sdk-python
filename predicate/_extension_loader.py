...
def find_extension_path() -> Path:
    ...
    1. predicate/extension/ (installed package)
    ...
    # predicate/_extension_loader.py -> predicate/extension/
    ...
    if package_ext_path.exists() and (package_ext_path / "manifest.json").exists():
        ...
        raise FileNotFoundError(
            ...
            f"2. {dev_ext_path}\n"
            "Make sure the extension is built and 'predicate/extension' directory exists."
        )
